...
var mtCookieDomain = ".partario.com";
var mtCookiePath = "/";
...
function mtFetchUser(cb) {
    ...
    if ( ( cb == 'mtSetUser' ) && mtGetUser() ) {
        ...
        script.src = 'http://mt.partario.com/mt-comments.cgi?__mode=session_js&blog_id=2&jsonp=' + cb + '&ts=' + ts;
...
function mtCommentOnSubmit(f) {
    if (!mtRequestSubmitted) {
        ...
        if (f.armor)
            f.armor.value = '0a7c81e6c40a4139649600f842865b0bf6d4e934';
...
function mtSignIn() {
    ...
    var url = 'http://mt.partario.com/mt-comments.cgi?__mode=login&blog_id=2';
    if (is_preview) {
        if ( document['comments_form'] ) {
            var entry_id = document['comments_form'].entry_id.value;
            url += '&entry_id=' + entry_id;
        } else {
            url += '&return_url=http%3A%2F%2Fwww.partario.com%2Fphotos%2F';
        }
    } else {
